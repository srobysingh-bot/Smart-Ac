...
async def start_session(room_id: str, data: Dict[str, Any]) -> str:
    ...
    record = {
        ...
        "last_confirmed_physical_on_at": data.get("last_confirmed_physical_on_at"),
        "last_valid_power_sample_at": data.get("last_valid_power_sample_at"),
        "last_valid_power_watts": data.get("last_valid_power_watts"),
